...
Route::middleware('contractor.module:orders')->group(function (): void {
    ...
    Route::post('/orders/{sale}/awaiting-payment', [OrderController::class, 'markAsAwaitingPayment'])->name('orders.awaiting-payment');
    ...
    Route::post('/orders/{sale}/delivery-status', [OrderController::class, 'updateDeliveryStatus'])->name('orders.delivery-status');
});
