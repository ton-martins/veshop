            ...
            <section class="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm md:p-5">
                <div class="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                    <div class="veshop-search-shell flex flex-1 items-center gap-2 rounded-xl border border-slate-200 bg-slate-50 px-3 py-2">
                        ...
                        <input type="text" placeholder="Buscar por OS ou cliente" class="veshop-search-input w-full bg-transparent text-sm text-slate-700 outline-none" />
                    </div>
                ...
                <div class="mt-4 overflow-hidden rounded-xl border border-slate-200">
                    <table class="min-w-full divide-y divide-slate-200 text-sm">
                        ...
                        <tbody v-if="serviceOrders.length" class="divide-y divide-slate-100 bg-white">
                    ...
                    <div v-if="!serviceOrders.length" class="px-4 py-8 text-center text-sm text-slate-500">
